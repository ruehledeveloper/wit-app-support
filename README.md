...
- **Safety at a Glance:** Understand complex car dashboard alerts or warning lights instantly.
- **Seamless Integration:** Use the Wit Share Extension to analyze images directly from your Photos app or any other app on your iPhone.
...
3. Find and tap **Wit** in the list of apps. (If you don't see it, tap "More" and add Wit to your favorites).

### I’m having trouble with an analysis. What should I do?
Ensure you have a stable internet connection, as the AI analysis requires a secure connection to our processing server.
