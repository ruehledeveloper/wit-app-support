...
**Wit** (abreviatura de "¿Qué es esto?") es una herramienta de análisis de IA minimalista y centrada en la privacidad para iOS. Te ayuda a entender el mundo que te rodea, desde identificar estafas de phishing hasta traducir menús de viaje, sin necesidad de una cuenta ni recopilación de datos.
...
Wit se creó con una filosofía de "Privacidad desde el diseño".

- **Sin cuentas:** No requerimos tu correo electrónico, número de teléfono ni nombre.
...
Wit proporciona información generada por IA únicamente con fines informativos. Incluso los sistemas de IA más avanzados pueden cometer errores. **Verifica siempre la información crítica de seguridad.**
